...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="f_name" name="f_name" placeholder="Enter First name" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <label class="checkbox-inline" for="is_admin-0">
      <input name="is_admin" id="is_admin-0" value="yes" type="checkbox">
    </label>
  </div>
</div>
